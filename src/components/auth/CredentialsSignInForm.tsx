  ...
  return (
    <div className="group rounded-2xl border border-slate-200/60 bg-white/95 p-8 shadow-2xl backdrop-blur-sm transition-all hover:border-slate-300/80 hover:shadow-3xl dark:border-slate-700/30 dark:bg-slate-800/95">
      ...
      <form className="mt-8 space-y-6" onSubmit={handleSubmit}>
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300" htmlFor="signin-email">
        ...
        <div className="space-y-2">
          <label className="flex items-center gap-2 text-sm font-medium text-slate-700 dark:text-slate-300" htmlFor="signin-password">
            <svg xmlns="http://www.w3.org/2000/svg" className="size-4 opacity-70" viewBox="0 0 20 20" fill="currentColor">
